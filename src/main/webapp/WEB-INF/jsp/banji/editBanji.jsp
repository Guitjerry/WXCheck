...
<div class="modal-body">
    <div class="input-group f-mb10 f-pd5">
        ...
        <input type="text" class="form-control" name="editname" id="editname" placeholder="请输入班级名称" aria-describedby="basic-addon1" value=" ${banji.name}">
    </div>
    ...
    <div class="input-group f-mt10 f-pd5">
        ...
        <input type="text" class="form-control" name="editStudentCount" id="editStudentCount" placeholder="请输入班级人数" aria-describedby="basic-addon2" value="${banji.studentCount}" >
    </div>
    <div class="input-group f-mt10 f-pd5">
        <span class="input-group-addon" id="basic-addon4">班级类别</span>
        <select class="form-control editbanjitype" name="editbanjitype" default-select="${banji.banjitype}" >
            <option value="">---请选择-----</option>
